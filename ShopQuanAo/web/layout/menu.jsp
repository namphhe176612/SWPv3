...
<div class="offcanvas_menu">
    ...
    <div class="offcanvas_menu_wrapper">
        ...
        <div class="welcome_text">
            <ul>
                <li><span>Quần áo chất lượng, giá yêu thương! </span>Nhanh tay lựa chọn ngay để khẳng định phong cách riêng! </li>
                <li><span>Sang trọng, tinh tế và thoải mái </span> Còn chần chờ gì mà không chọn ngay cho mình một bộ!</li>
            </ul>
        </div>
        <div class="top_right">
            <ul>
        ...
        <div class="offcanvas_footer">
            <span><a href="#"><i class="fa fa-envelope-o"></i> namphhe176612@fpt.edu.vn</a></span>
            <ul>
